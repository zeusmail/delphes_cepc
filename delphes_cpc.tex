...
%\begin{enumerate}
%\item[-] Silicon Inner Tracker(SIT), cooperating with VTX for vertex reconstruction and flavor-tagging.
...
\figcaption{\label{fig:zh4qsc} The Scattering plots of $M_{j_1,j_2}$ vs. $M_{j_3,j_4}$ for full and fast simulations, respectively.}
\end{center}
...
\figcaption{\label{fig:input} Two dimensional distributions of $b$-likeliness and $c$-likeliness for $b$, $c$ and light jets,
