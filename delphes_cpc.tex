...
The simulation and reconstruction in {\textsc{Delphes}~} must be validated by comparing the resolutions
...
%For this purpose, all the relevant distributions should be compared by checking the shapes, the resolutions, as well as the efficiencies.
%In these plots, the outputs from {\textsc{Delphes}~} approximately agree with the full simulation cases, some points should be mentioned:

\subsection{$e^+e^-\to \mu^+\mu^-H$}

For $e^+e^- \to \mu^+\mu^-H$ channel, the di-muons come from Z boson decay, and Higgs is tagged from the recoiling side,
so the invariant mass of those systems represent $Z$ meanwhile the recoiling mass Higgs.
...
\begin{center}
\includegraphics[width=0.4\linewidth]{e2e2h_mass}
\includegraphics[width=0.4\linewidth]{e2e2h_reco}
...
\subsection{$e^+e^-\to \nu\bar{\nu}H$, $H \to WW^*$}
In $e^+e^- \to \nu\bar{\nu}H,~H\to WW^*$,
all the visible information comes from $WW^*$ and eventually from Higgs.
The plots in Fig.~\ref{fig:nnh} show distributions of the invariant masses of jet pairs, which represent Higgs and $Z$
(here it includes the $WW$ fusion contribution), respectively.


\begin{center}
\includegraphics[width=0.4\linewidth]{nnh_mass}
\includegraphics[width=0.4\linewidth]{nnh_reco}
\figcaption{\label{fig:nnh} The distributions of invariant mass of and recoil mass against $WW^*$ system
  in $e^+e^- \to \nu\bar{\nu}H$, $H\to WW^{*}$.}
\end{center}

\subsection{$e^+e^- \to ZH \to 2(q\bar{q})$}
For the $e^+e^- \to ZH \to 2(q\bar{q})$ processes,
the Delphes fast simulation on the invariant mass peak of jet pair at $Z$ mass and Higgs mass shown
in Fig.~\ref{fig:zh4q} are both in well argeement with full simulation.
In Fig.~\ref{fig:zh4qsc}, the scattering plots intuitively show the difference between fast simulation and full simulation.

\begin{center}
\includegraphics[width=0.4\linewidth]{full_vs_delphes_z}
\includegraphics[width=0.4\linewidth]{full_vs_delphes_h}
\figcaption{\label{fig:zh4q} The invariant mass distributions of the jet pairs, which are peaking at $Z$ and Higgs masses.}
\end{center}


\begin{center}
\includegraphics[width=0.45\linewidth]{Full2DCOL}
\includegraphics[width=0.45\linewidth]{Fast2DCOL}
