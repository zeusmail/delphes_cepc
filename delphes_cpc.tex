...
\figcaption{\label{fig:input} Two dimensional distributions of $b$-likelyness and $c$-likelyness for $b$, $c$ and light jets, which are from full simulation and taken as input to fast simulaiton. }
\end{center}
